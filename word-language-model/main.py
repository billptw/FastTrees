...
parser.add_argument('--lm_data', type=str, default='./data/lm_data',
...
parser.add_argument('--model', type=str, default='ON',
                    help='ON, FT, FFT, CFT, LSTM')
...
parser.add_argument('--save', type=str,  default='models/lstm_lm.pt',
                    help='path to save the final model')
parser.add_argument('--single', action='store_true',
                    help='use only a single GPU (even if more are available)')
parser.add_argument('--save_lm_data', type=str, default='models/lstm_lm.bin',
