...
class ONLSTMCell(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, chunk_size, dropconnect=0.):
        ...
        self.ih = nn.Sequential(nn.Linear(input_size, 4 * hidden_size, bias=True))
    ...
    def forward(self, input, hidden, transformed_input=None, gates=None):
        hx, cx = hidden
        ...
        return hy.view(-1, self.hidden_size), cy, (None, None)
...
class LSTMStack(nn.Module):
    ...
    def forward(self, input, hidden):
        ...
        return output, prev_state, raw_outputs, outputs, (None, None)
